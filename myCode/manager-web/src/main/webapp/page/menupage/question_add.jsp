...
<html>
	...
	<body class="easyui-layout">
		...
		<div data-options="region:'center'">
			<form id="menuForm" method="post" action="/manager-web/adminExam/addQuestions">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>题目等级</td>
						<td>
							<input type="text" name="quesLevel" class="easyui-validatebox" data-options="required:true" />
						</td>
					</tr>
					<tr>
						<td>题目内容</td>
						<td>
							<input type="text" name="quesContent" class="easyui-validatebox" data-options="required:true" />
						</td>
					</tr>
					<tr>
						<td>选项A</td>
